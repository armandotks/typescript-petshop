...
const testimonials = [
    {
        content: "Desde que comecei a levar a Luna para banho e tosa aqui, ela nunca este tão feliz! O atendimento é impecável, os profissionais são super cuidadosos e sempre deixam minha peluda linda e cheirosa. Recomendo de olhos fechados!",
        author: "João",
        role: "Tutor da luna (Golden Retriver)",
        image: tutor1,
    },
    {
        content: "O serviço de hotel para pets foi uma experiência incrível! Precisei viajar e fiquei tranquilo sabendo que a Safira estava sendo bem cuidada. Recebi fotos e atualizações diárias, e ela voltou para casa super feliz! Sem dúvida, o melhor petshop da região.",
        author: "Daniel",
        role: "Tutor da Safira (Pinscher)",
        image: tutor2,
    },
    {
